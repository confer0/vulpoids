...
public class VulpoidModPlugin_OLD extends BaseModPlugin {
    ...
    public void onGameLoad(boolean newGame) {
        ...
        //final int VULPOID_INCOME_PER_PROD = 10000;
        ...
        ItemEffectsRepo.ITEM_EFFECTS.put("vulpoid_biofactory", new BaseInstallableItemEffect("vulpoid_biofactory") {
            public void apply(Industry industry) {
                ...
                if (industry instanceof BaseIndustry) {
                    ...
                    //industry.getIncome().modifyFlat(spec.getId(), VULPOID_INCOME_PER_PROD*supplied_amount, "Vulpoid exports");
                    
                    for(MarketAPI market : Global.getSector().getEconomy().getMarketsCopy()) {
                        market.addCondition("vulpoid_demand");
                    }
                }
            }
